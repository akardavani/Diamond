...
{
    public class InvestingCandelClientService : IBusinessService
    {
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly Settings _settings;
        string url = string.Empty;
        public InvestingCandelClientService(IOptions<Settings> settings, IHttpClientFactory httpClientFactory)
        {
            ...
            if (_settings != null)
            {
                url = _settings.CandelSettings.Investing;
        ...
        public async Task<CandelDataModel> GetDataByUrl(string symbol, TimeframeEnum timeframe)
        {
            try
            {
                ...
                //var url = _settings.CandelSettings.HistoryUrl
                    //url.Replace("@Symbol", symbol + adjustmentType)
        ...
        public async Task<List<CandelModel>> GetDataByUrl(string url)
        {
            try
            {
                var data = await GetDataFromUrl.GetInvestingUrl(url);
