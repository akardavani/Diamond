...
{
    public class IchimokuStrategyHandler : ITradingStrategyHandler<IchimokuStrategyCommand>
    {
        ...
        public IchimokuStrategyHandler(DiamondDbContext dbContext,
        ...
        public async Task TradingSignal(IchimokuStrategyCommand StrategyName, CancellationToken cancellation)
        {
